...
class SelectCustomControlTest extends AbstractFormHelperTest
{
    ...
    public function testDefaultAlignCustomSelectControlWithCustomLabelOptions()
    {
        $this->Form->create($this->article);
    ...
    public function testDefaultAlignCustomSelectControlWithHelp()
    {
        $this->Form->create($this->article);
    ...
    public function testDefaultAlignCustomSelectControlWithHelpOptions()
    {
        $this->Form->create($this->article);
