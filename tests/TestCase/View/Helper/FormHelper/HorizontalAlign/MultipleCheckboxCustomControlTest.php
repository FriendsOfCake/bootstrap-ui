...
class MultipleCheckboxCustomControlTest extends AbstractFormHelperTest
{
    ...
    public function testHorizontalAlignCustomMultipleCheckboxControlWithCustomLabelOptions()
    {
        $this->Form->create($this->article, [
            'align' => [
                'sm' => [
    ...
    public function testHorizontalAlignCustomMultipleCheckboxControlWithCustomLabelTemplateIsBackwardsCompatible()
    {
        $this->Form->create($this->article, [
            'align' => [
                'sm' => [
    ...
    public function testHorizontalAlignCustomMultipleCheckboxControlInlineWithCustomLabelOptions()
    {
        $this->Form->create($this->article, [
            'align' => [
                'sm' => [
    ...
    public function testHorizontalAlignCustomMultipleCheckboxControlInlineWithCustomLabelTemplateIsBackwardsCompatible()
    {
        $this->Form->create($this->article, [
            'align' => [
                'sm' => [
    ...
    public function testHorizontalAlignCustomMultipleCheckboxControlInlineWithHelp()
    {
        $this->Form->create($this->article, [
            'align' => [
                'sm' => [
